...
<img class="nml__editor__content__image" src="${HOST_API}/assets/images/cover/cover-5.webp">
...
<img class="nml__editor__content__image" src="${HOST_API}/assets/images/cover/cover-14.webp">
`;
