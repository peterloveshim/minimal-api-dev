  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        ...
        contentType: 'text',
        attachments: [],
        createdAt: fSub({ hours: 4, minutes: 30 }),
        senderId: _contacts[2].id,
      },
      {
        id: uuidv4(),
        ...
        contentType: 'text',
        attachments: [],
        createdAt: fSub({ hours: 2, minutes: 15 }),
        senderId: MY_CONTACT.id,
      },
      {
        id: uuidv4(),
        ...
        contentType: 'text',
        attachments: [],
        createdAt: fSub({ hours: 1, minutes: 15 }),
        senderId: _contacts[2].id,
      },
      {
        id: uuidv4(),
